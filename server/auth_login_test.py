...
def test_auth_login(): 
    #no capitals
    assert auth_login("besthearthstoneplayer@gmail.com", "bigpabo") == ("besthearthstoneplayer@gmail.com", "bigpabo")
    #capitals 
    assert auth_login("BestHearthstonePlayer@gmail.com", "BigPabo") == ("BestHearthstonePlayer@gmail.com", "BigPabo")
    #numbers
    assert auth_login("besthearthstoneplayer@gmail.com", "b1gp4b0") == ("besthearthstoneplayer@gmail.com", "b1gp4b0")
    #numbers in email
    assert auth_login("rank87legend@gmail.com", "bigpabo") == ("rank87legend@gmail.com", "bigpabo")
    #special expressions in email
    assert auth_login("Message.To.Daniel.Kang@gmail.com", "Jihyo") == ("Message.To.Daniel.Kang@gmail.com", "Jihyo")
    #non-gmail emails
    assert auth_login("IC_THAT_IM_ICY@microsoftoutlook.com", "ITZY5") == ("IC_THAT_IM_ICY@microsoftoutlook.com", "ITZY5")
